            ...
            {detail.map(item => (
                <div key={item.show.id}>
                    <div className="d-flex flex-row align-items-center flex-grow position-relative">
                        ...
                        <div className="d-flex flex-row position-absolute ms-5">
                            <Card >
                                <Card.Img
                                    variant="top"
                                    height="400px"
                            ...
                            <div className="d-flex flex-column justify-content-around text-white ms-5 g-3">
                            ...
                            <Button onClick={() => setClicked(true)} size="lg" style={{fontSize: "30px"}}
                                 className="btn btn-danger text-white align-items-end d-flex align-self-center">Book
                            tickets</Button>
                        </div>
                    </div>
                    <div className="m-5 ">
